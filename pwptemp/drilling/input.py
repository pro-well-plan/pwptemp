def data(casings=[], d_openhole=0.216, units='metric'):
    ...
    dict_met = {'tin': 20.0, 'ts': 15.0, 'wd': 0.0,  'ddi': 4.0, 'ddo': 4.5, 'dri': 17.716, 'dro': 21.0, 'dfm': 80.0,
            ...
            'rhow': 1.029, 'rhocem': 2.7, 'gt': 0.0238, 'wtg': -0.005, 'rpm': 100.0, 'tbit': 0, 'wob': 0, 'rop': 30.4,
